        ...
        <>
            ...
            <div className="min-h-screen bg-black text-white font-sans">
                <main className="flex min-h-screen flex-col items-center justify-center px-4 py-8 font-sans sm:px-6 sm:py-12">
                    ...
                    {/* Leaderboard Section */}
                    <section className="w-full max-w-4xl mt-12 sm:mt-16 px-4 sm:px-0 mb-12">
                        <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-center">🏆 Ranking</h2>
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="bg-gray-800/50 text-left text-xs uppercase tracking-wider text-gray-400">
                                        ...
                                        <th className="px-4 sm:px-6 py-4 font-medium">Dev</th>
                                        <th className="px-4 sm:px-6 py-4 font-medium text-right">Pontos</th>
                                        <th className="px-4 sm:px-6 py-4 font-medium text-right hidden sm:table-cell">Frases</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-800">
                                    {[
                                        { rank: 1, username: 'DevMaster', points: 5420, phrases: 142 },
                                        { rank: 2, username: 'CodeNinja', points: 4890, phrases: 128 },
                                        { rank: 3, username: 'BugHunter', points: 4120, phrases: 105 },
                                        { rank: 4, username: 'StackOverflow', points: 3890, phrases: 98 },
                                        { rank: 5, username: 'GitCommit', points: 3450, phrases: 87 },
                                    ].map((entry) => (
                                        <tr key={entry.rank} className="hover:bg-gray-800/30 transition-colors">
                                            <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                                                <span className={`flex items-center justify-center w-8 h-8 rounded-full font-bold text-sm ${entry.rank === 1 ? 'bg-yellow-500/20 text-yellow-500' :
                                            ...
                                            <td className="px-4 sm:px-6 py-4 whitespace-nowrap font-medium">{entry.username}</td>
                                            <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-right font-bold text-white">
                                                {entry.points.toLocaleString()}
                                            </td>
                                            <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-right text-gray-400 hidden sm:table-cell">
                                                {entry.phrases}
                                            </td>
                                        </tr>
                                    ))}
                        ...
                        <p className="text-center text-gray-500 text-xs sm:text-sm mt-4">
                            Compartilhe frases e suba no ranking! 🚀
                        </p>
                    </section>
                    ...
                    <footer className="text-center px-4">
                        <nav className="mb-6">
                            <div className="flex flex-wrap justify-center gap-4 mb-4">
                                ...
                                <a href="/contato" className="text-gray-400 hover:text-gray-300 transition-colors text-sm underline">
                                    Contato
                                </a>
